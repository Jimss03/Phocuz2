...
import static com.Destura.notesapp.untimequiz.toQuizpythonuntime.list;
...
public class Quizpythonuntime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizpythonuntime);
        ...
        ic_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Quizpythonuntime.this, QuizActivity.class);
    ...
    private void gameWon() {
        Intent intent= new Intent(Quizpythonuntime.this, WonActivity.class);
