...
public class myadapter4 extends FirebaseRecyclerAdapter<model, myadapter4.myviewholder>
{
    FirebaseUser user;
    String uid;


    public myadapter4(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                FirebaseDatabase.getInstance().getReference("upload2").child(uid)
