...
public class On_Off_Page extends Fragment {
    ...
    private final String TAG = notiblocker.class.getSimpleName();
        ...
        try {
            ...
            if (blockList != null) {
                if (blockList.getStatus().equals("no") || blockList.getStatus().equals("yes")) {
                    ...
                    on.setTextColor(getResources().getColor(R.color.cardview_light_background));
            ...
            on.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    if (on.getTag().equals("RUNNING")) {
                        ...
                        customView = inflater1.inflate(R.layout.activity_notiblocker, null);
            ...
            off.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    try {
                        off.setTextColor(getResources().getColor(R.color.cardview_light_background));
    ...
    public void bannerad() {
        ...
        adView.setAdListener(new AdListener() {
            ...
            public void onError(Ad ad, AdError adError) {
                // Ad error callback
                /*Toast.makeText(notePage.this, "Error: " + adError.getErrorMessage(),
