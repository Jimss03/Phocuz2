...
import com.Destura.notesapp.Pdf.myadapter4;
...
public class Pdfactivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdfactivity4);
        ...
        fb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), uploadfile4.class));
            }
        });
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference("upload2").child(uid),
                                model.class)
                        .build();
